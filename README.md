...
> **:warning:** You need *write access* to the Dotty installation directory (e.g. **`C:\opt\dotty-0.17.0-RC1\`** in our case) in order to successfully run the **`activate/reset`** subcommands.
