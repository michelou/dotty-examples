...
For instance our development environment looks as follows (*December 2022*) <sup id="anchor_04">[4](#footnote_04)</sup>:
...
C:\opt\scala3-3.2.2-RC1\           <i>( 35 MB)</i>
</pre>
...
3. Directory [**`bin\3.0\`**](bin/3.0/) - This directory contains batch files to be copied to the **`bin\`** directory of the [Scala 3][scala3_home] installation for versions *prior to 3.0.2* in order to use the [**`scalac.bat`**](bin/3.0/scalac.bat), [**`scaladoc.bat`**](bin/3.0/scaladoc.bat) and [**`scala.bat`**](bin/3.0/scala.bat) commands on **Microsoft Windows**.
    ...
    <pre style="font-size:80%;">
    <b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/dir">dir</a> /b c:\opt\scala3-3.2.2-RC1\bin</b>
...
Tool versions:
   ...
   bazel 5.3.2, bloop v1.3.4, cfr 0.152, make 3.81, python 3.11.0,
...
Tool paths:
   ...
   C:\opt\scala3-3.2.2-RC1\bin\scalac.bat
...
<pre style="font-size:80%;">
<b>&gt; <a href="bin/dirsize.bat">dirsize</a> examples myexamples c:\opt\scala3-3.2.2-RC1 c:\opt\jdk-temurin-11.0.17_8</b>
Size of directory "examples" is 3.9 Mb
Size of directory "myexamples" is 1.2 Mb
Size of directory "c:\opt\scala3-3.2.2-RC1" is 35.7 Mb
...
Downloading file scaladoc_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 3.7 Mb
Downloading file scala3-interfaces-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 3.5 Kb
Downloading file scala3-library_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 1.2 Mb
Downloading file scala3-compiler_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 16.8 Mb
Downloading file scala3-language-server_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 149.2 Kb
Downloading file scala3-staging_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 37.8 Kb
Downloading file tasty-core_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 72.4 Kb
Downloading file scala3-library_sjs1_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 1.9 Mb
Downloading file scala3-tasty-inspector_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 17.4 Kb
Downloading file scala3-sbt-bridge-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar ... 21.8 Kb
...
scala3-compiler_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-interfaces-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-language-server_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-library_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-library_sjs1_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-sbt-bridge-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-staging_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scala3-tasty-inspector_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
scaladoc_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
snakeyaml-1.27.jar
strftime4j-1.0.5.jar
tasty-core_3-3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY.jar
</pre>
<!--
...
Active Scala 3 installation is 3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY (was 3.2.2-RC1)

<b>&gt; %SCALA3_HOME%\bin\<a href="bin/3.0/scalac.bat">scalac</a> -version</b>
Scala compiler version 3.3.0-RC1-bin-20221130-72c4ffd-NIGHTLY-git-93fc41f -- Copyright 2002-2022, LAMP/EPFL

<b>&gt; <a href="bin/getnightly.bat">getnightly</a> restore</b>
Active Scala 3 installation is 3.2.2-RC1

<b>&gt; %SCALA3_HOME%\bin\<a href="bin/3.0/scalac.bat">scalac</a> -version</b>
Scala compiler version 3.2.2-RC1 -- Copyright 2002-2022, LAMP/EPFL
</pre>

> **:warning:** You need *write access* to the [Scala 3][scala3_home] installation directory (e.g. **`C:\opt\scala3-3.2.2-RC1\`** in our case) in order to successfully run the **`activate/reset`** subcommands.
...
Searching for class name System in archive files C:\opt\scala3-3.2.2-RC1\lib\*.jar
...
Searching for class name FileSystem in archive files C:\opt\scala3-3.2.2-RC1\lib\*.jar
...
| :----------- | :------: | :------ |
| `build.sbt` | `dottyVersion` | `3.2.2-RC1-RC1` &rarr; `3.2.2-RC1`|
| `build.sc` | `scalaVersion` | `3.2.2-RC1-RC1` &rarr; `3.2.2-RC1` |
...
C:\opt\scala3-3.2.2-RC1\bin\scala
C:\opt\scala3-3.2.2-RC1\bin\scala.bat
...
val res1: String = C:\opt\scala3-3.2.2-RC1
...
<a href="https://github.com/lampepfl/dotty/releases/tag/3.2.2-RC1">scala3-3.2.2-RC1.zip</a>                               <i>( 34 MB)</i>
</pre>
</dd></dl>
...
[scala3_relnotes]: https://github.com/lampepfl/dotty/releases/tag/3.2.2-RC1
