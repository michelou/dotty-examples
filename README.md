...
C:\opt\scala3-3.2.1-RC1\           <i>( 35 MB)</i>
</pre>
...
3. Directory [**`bin\3.0\`**](bin/3.0/) - This directory contains batch files to be copied to the **`bin\`** directory of the [Scala 3][scala3_home] installation for versions *prior to 3.0.2* in order to use the [**`scalac`**](bin/3.0/scalac.bat), [**`scaladoc`**](bin/3.0/scaladoc.bat) and [**`scala`**](bin/3.0/scala.bat) commands on **Microsoft Windows**.
    ...
    <pre style="font-size:80%;">
    <b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/dir">dir</a> /b c:\opt\scala3-3.2.1-RC1\bin</b>
...
Tool versions:
   javac 11.0.16, java 11.0.16, scalac 2.13.8, scalac 3.2.1-RC1,
...
Tool paths:
   ...
   C:\opt\scala3-3.2.1-RC1\bin\scalac.bat
...
Environment variables:
   ...
   "SCALA3_HOME=C:\opt\scala3-3.2.1-RC1"
</pre>
...
<pre style="font-size:80%;">
<b>&gt; <a href="bin/dirsize.bat">dirsize</a> examples myexamples c:\opt\scala3-3.2.1-RC1 c:\opt\jdk-temurin-11.0.16_8</b>
Size of directory "examples" is 3.9 Mb
Size of directory "myexamples" is 1.2 Mb
Size of directory "c:\opt\scala3-3.2.1-RC1" is 35.7 Mb
...
Active Scala 3 installation is 3.2.0-RC5-bin-20220413-93fc41f-NIGHTLY (was 3.2.1-RC1)
...
Active Scala 3 installation is 3.2.1-RC1

<b>&gt; %SCALA3_HOME%\bin\<a href="bin/3.0/scalac.bat">scalac</a> -version</b>
Scala compiler version 3.2.1-RC1 -- Copyright 2002-2022, LAMP/EPFL
</pre>

> **:warning:** You need *write access* to the [Scala 3][scala3_home] installation directory (e.g. **`C:\opt\scala3-3.2.1-RC1\`** in our case) in order to successfully run the **`activate/reset`** subcommands.
...
Searching for class name System in archive files C:\opt\scala3-3.2.1-RC1\lib\*.jar
  jline-reader-3.19.0.jar:org/jline/reader/impl/completer/SystemCompleter.class
  scala-library-2.13.8.jar:scala/sys/SystemProperties$.class
  scala-library-2.13.8.jar:scala/sys/SystemProperties.class
...
Searching for class name FileSystem in archive files C:\opt\scala3-3.2.1-RC1\lib\*.jar
...
| :----------- | :------: | :------ |
| `build.sbt` | `dottyVersion` | `3.1.2-RC3` &rarr; `3.2.1-RC1`|
| `build.sc` | `scalaVersion` | `3.1.2-RC3` &rarr; `3.2.1-RC1` |
...
C:\opt\scala3-3.2.1-RC1\bin\scala
C:\opt\scala3-3.2.1-RC1\bin\scala.bat

<b>&gt; <a href="bin/3.0/scala.bat">scala</a> -version</b>
Scala code runner version 3.2.1-RC1 -- Copyright 2002-2022, LAMP/EPFL
...
val res1: String = C:\opt\scala3-3.2.1-RC1
...
<a href="https://github.com/lampepfl/dotty/releases/tag/3.2.1-RC1">scala3-3.2.1-RC1.zip</a>                               <i>( 34 MB)</i>
</pre>
</dd></dl>
...
[scala3_relnotes]: https://github.com/lampepfl/dotty/releases/tag/3.2.1-RC1
