...
call "%_JAVACMD%" -Dscala.usejavacp=true -classpath "%_CLASS_PATH%" dotty.tools.dottydoc.Main %*
if not %ERRORLEVEL%==0 (
...
set _CLASS_PATH=%_DOTTY_LIB%%_PSEP%%_DOTTY_COMP%%_PSEP%%_TASTY_CORE%%_PSEP%%_DOTTY_DOC_LIB%%_PSEP%%_DOTTY_INTF%%_PSEP%%_SBT_INTF%%_PSEP%%_DOTTY_STAGING%%_PSEP%%_DOTTY_TASTY_INSPECTOR%
