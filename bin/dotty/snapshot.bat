...
set _EIGHT=bellsoft-08 corretto-08 dragonwell-08 graalvm-ce-08 openj9-08 redhat-08 temurin-08 zulu-08
set _ELEVEN=bellsoft-11 bellsoft-nik-11 corretto-11 dcevm-11 dragonwell-11 graalvm-ce-11 microsoft-11 openj9-11 redhat-11 sapmachine-11 temurin-11 zulu-11
set _SEVENTEEN=bellsoft-17 bellsoft-nik-17 corretto-17 graalvm-ce-17 microsoft-17 sapmachine-17 temurin-17 zulu-17
...
for /f %%d in ('dir /ad /b "c:\opt\jdk-temurin-1.8*"') do set "_MAP[temurin-08]=c:\opt\%%d"
for /f %%d in ('dir /ad /b "c:\opt\jdk-temurin-11*"') do set "_MAP[temurin-11]=c:\opt\%%d"
for /f %%d in ('dir /ad /b "c:\opt\jdk-temurin-17*"') do set "_MAP[temurin-17]=c:\opt\%%d"
