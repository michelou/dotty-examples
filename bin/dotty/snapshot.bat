...
set _SEVENTEEN=bellsoft-17 bellsoft-nik-17 corretto-17 graalvm-ce-17 microsoft-17 redhat-17 sapmachine-17 temurin-17 zulu-17

@rem for %%i in (%_EIGHT% %_ELEVEN% %_SEVENTEEN%) do (
for %%i in (temurin-08) do (
...
call :env_set redhat-17 "c:\opt\jdk-redhat-17*"

call :env_set sapmachine-11 "c:\opt\jdk-sapmachine-11*"
call :env_set sapmachine-17 "c:\opt\jdk-sapmachine-17*"

call :env_set temurin-08 "c:\opt\jdk-temurin-1.8*"
call :env_set temurin-11 "c:\opt\jdk-temurin-11*"
call :env_set temurin-17 "c:\opt\jdk-temurin-17*"
