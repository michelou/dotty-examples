...
set _DOTTY_VERSION_OLD="3.0.0-M2"
set _DOTTY_VERSION_NEW="3.0.0-M3"

@rem files project\build.properties
set _SBT_VERSION_OLD=sbt.version=1.4.3
set _SBT_VERSION_NEW=sbt.version=1.4.4

@rem files project\plugins.sbt
@rem see https://search.maven.org/artifact/ch.epfl.lamp/sbt-dotty/
set _SBT_DOTTY_VERSION_OLD="0.5.0"
set _SBT_DOTTY_VERSION_NEW="0.5.1"
...
set _IVY_DOTTY_VERSION_OLD=^(scala3-[a-z]+^)_3.0.0-M2
set _IVY_DOTTY_VERSION_NEW=$1_3.0.0-M3

set _IVY_TASTY_VERSION_OLD=^(tasty-[a-z]+^)_3.0.0-M2
set _IVY_TASTY_VERSION_NEW=$1_3.0.0-M3

@rem files pom.xml (NB. PS regex)
set _POM_DOTTY_VERSION_OLD=scala.version^>3.0.0-M2
set _POM_DOTTY_VERSION_NEW=scala.version^>3.0.0-M3

@rem files common.gradle
set _GRADLE_DOTTY_VERSION_OLD=scala3-compiler_3.0.0-M1:3.0.0-M2
set _GRADLE_DOTTY_VERSION_NEW=scala3-compiler_3.0.0-M2:3.0.0-M3
