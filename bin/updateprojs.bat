...
set _DOTTY_VERSION_OLD="3.1.1-RC1"
set _DOTTY_VERSION_NEW="3.1.1-RC2"

@rem files project\build.properties
set _SBT_VERSION_OLD=sbt.version=1.5.7
set _SBT_VERSION_NEW=sbt.version=1.5.8
...
set _SCALATEST_VERSION_OLD=^(\"scalatest_2.13\"^)^(.+\"3.2.9\"^)
set _SCALATEST_VERSION_NEW=$1 %%%% \"3.2.10\"

@rem files ivy.xml (NB. PS regex)
set _IVY_DOTTY_VERSION_OLD=^(scala3-[a-z]+^)_3.1.1-RC1
set _IVY_DOTTY_VERSION_NEW=$1_3.1.1-RC2

set _IVY_TASTY_VERSION_OLD=^(tasty-[a-z]+^)_3.1.1-RC1
set _IVY_TASTY_VERSION_NEW=$1_3.1.1-RC2

@rem files pom.xml (NB. PS regex)
set _POM_DOTTY_VERSION_OLD=scala.version^>3.1.1-RC1
set _POM_DOTTY_VERSION_NEW=scala.version^>3.1.1-RC2

@rem files common.gradle
set _GRADLE_DOTTY_VERSION_OLD=scala3-compiler_3:3.1.1-RC1
set _GRADLE_DOTTY_VERSION_NEW=scala3-compiler_3:3.1.1-RC2
