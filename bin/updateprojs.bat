...
rem file build.sbt
set _DOTTY_VERSION_OLD="0.12.0-RC1"
set _DOTTY_VERSION_NEW="0.13.0-RC1"
...
set _SBT_DOTTY_VERSION_OLD="0.2.6"
set _SBT_DOTTY_VERSION_NEW="0.3.0"

rem file build.sc
set _MILL_DOTTY_VERSION_OLD="0.12.0-RC1"
set _MILL_DOTTY_VERSION_NEW="0.13.0-RC1"
