...
for /f %%i in ('dir /b /s "%_TEST_CLASSES_DIR%\*JUnitTest.class" 2^>NUL') do (
    set "__MAIN_CLASS_FILE=%%~dpni"
    set __MAIN_CLASS_FILE=!__MAIN_CLASS_FILE:%_TEST_CLASSES_DIR%\=!
    set "__MAIN_CLASS=!__MAIN_CLASS_FILE:\=.!"
