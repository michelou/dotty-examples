...
<span style="font-weight:bold;color:#9966ff;">init.local:</span>
     [echo] SCALA3_HOME=C:\opt\scala3-3.3.1-RC3
...
Tool versions:
   javac 11.0.18, java 11.0.18, scalac 2.13.10, scalac 3.3.1-RC3,
   ant 1.10.13, gradle 8.1.1, mill 0.10.11, mvn 3.9.2, sbt 1.8.2,
   bazel 6.2.0, cfr 0.152, coursier 2.0.16, make 3.81, python 3.11.1,
   git 2.40.1.windows.1, diff 3.8, bash 5.2.15(1)-release
&nbsp;
user@host MSYS /w
...
SCALA3_HOME=C:\opt\scala3-3.3.1-RC3
...
Tool versions:
   javac 11.0.19 java 11.0.19 scalac 2.13.10, scalac 3.3.1-RC3,
   ant 1.10.13, gradle 8.1.1, mill 0.10.11, mvn 3.9.2, sbt 1.8.2,
   bazel 6.2.0, cfr 0.152, coursier 2.0.16, make 3.81, python 3.11.1,
...
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.19_7\bin\java.exe \
 -Xms64m -Xmx1024m -Dscala.home=C:\opt\scala3-3.3.1-RC3 \
 -cp C:\opt\scala3-3.3.1-RC3\lib\*.jar -Dscala.usejavacp=true  \
...
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.19_7\bin\java.exe \
 -Xms64m -Xmx1024m -Dscala.home=C:\opt\scala3-3.3.1-RC3 [...]
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.19_7\bin\java.exe \
 -Xms64m -Xmx1024m -cp C:\opt\scala3-3.3.1-RC3\lib\*.jar;\
...
[INFO] --------------------------------[ jar ]---------------------------------
[..]
[INFO] --- maven-jar-plugin:3.3.1-RC3:jar (default-jar) @ HelloWorld ---
...
>         <b>&lt;scala.version&gt;</b>3.3.1-RC3<b>&lt;/scala.version&gt;</b>
...
<pre style="font-size:80%;">
<b>&gt;</b> <a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html">java</a> -Xbootclasspath/a:c:\opt\scala3-3.3.1-RC3\lib\dotty-library_3-3.3.1-RC3.jar;^
c:\opt\scala3-3.3.1-RC3\lib\scala-library-2.13.10.jar ^
...
> <pre style="font-size:80%;">
> <b>&gt; <a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html">java</a> -Xbootclasspath/a:c:\opt\scala3-3.3.1-RC3\lib\scala3-library_3-3.3.1-RC3.jar -jar target\enum-Color-1.0-SNAPSHOT.jar</b>
...
> Searching for class name Serializable in library files C:\opt\scala3-3.3.1-RC3\lib\*.jar
...
> </pre>
> Class **`scala.Serializable`** is part of **`C:\opt\scala3-3.3.1-RC3\lib\scala-library-2.13.10.jar`**, so let us add it to our classpath !
...
[apache_maven_cli]: https://maven.apache.org/ref/3.9.2/maven-embedder/cli.html
