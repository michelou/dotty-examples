...
<span style="font-weight:bold;color:#9966ff;">init.local:</span>
     [echo] SCALA3_HOME=C:\opt\scala3-3.3.0-RC5
...
Tool versions:
   javac 11.0.18, java 11.0.18, scalac 2.13.10, scalac 3.3.0-RC5,
   ant 1.10.13, gradle 8.1.1, mill 0.10.11, mvn 3.8.7, sbt 1.8.2,
   bazel 6.1.2, cfr 0.152, coursier 2.0.16, make 3.81, python 3.11.1,
...
SCALA3_HOME=C:\opt\scala3-3.3.0-RC5
...
Tool versions:
   javac 11.0.19 java 11.0.19 scalac 2.13.10, scalac 3.3.0-RC5,
   ant 1.10.13, gradle 8.1.1, mill 0.10.11, mvn 3.8.7, sbt 1.8.2,
   bazel 6.1.2, cfr 0.152, coursier 2.0.16, make 3.81, python 3.11.1,
...
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.18_8\bin\java.exe \
 -Xms64m -Xmx1024m -Dscala.home=C:\opt\scala3-3.3.0-RC5 \
 -cp C:\opt\scala3-3.3.0-RC5\lib\*.jar -Dscala.usejavacp=true  \
...
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.19_7\bin\java.exe \
 -Xms64m -Xmx1024m -Dscala.home=C:\opt\scala3-3.3.0-RC5 [...]
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.19_7\bin\java.exe \
 -Xms64m -Xmx1024m -cp C:\opt\scala3-3.3.0-RC5\lib\*.jar;\
...
[INFO] --------------------------------[ jar ]---------------------------------
[..]
[INFO] --- maven-jar-plugin:3.3.0-RC5:jar (default-jar) @ HelloWorld ---
...
>         <b>&lt;scala.version&gt;</b>3.3.0-RC5<b>&lt;/scala.version&gt;</b>
...
<pre style="font-size:80%;">
<b>&gt;</b> <a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html">java</a> -Xbootclasspath/a:c:\opt\scala3-3.3.0-RC5\lib\dotty-library_3-3.3.0-RC5.jar;^
c:\opt\scala3-3.3.0-RC5\lib\scala-library-2.13.10.jar ^
...
> <pre style="font-size:80%;">
> <b>&gt; <a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html">java</a> -Xbootclasspath/a:c:\opt\scala3-3.3.0-RC5\lib\scala3-library_3-3.3.0-RC5.jar -jar target\enum-Color-1.0-SNAPSHOT.jar</b>
...
> Searching for class name Serializable in library files C:\opt\scala3-3.3.0-RC5\lib\*.jar
...
> </pre>
> Class **`scala.Serializable`** is part of **`C:\opt\scala3-3.3.0-RC5\lib\scala-library-2.13.10.jar`**, so let us add it to our classpath !
