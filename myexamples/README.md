...
<span style="font-weight:bold;color:#9966ff;">init.local:</span>
     [echo] SCALA3_HOME=C:\opt\scala3-3.2.1-RC2
...
Tool versions:
   ...
   bazel 5.3.1, cfr 0.152, coursier 2.0.16, make 3.81, python 3.10.7,
...
GNU bash, version 5.3.16(1)-release (x86_64-pc-msys)
&nbsp;
...
[DEBUG] [execute] C:\opt\jdk-temurin-11.0.14_9\bin\java.exe \
 -Xms64m -Xmx1024m -Dscala.home=C:\opt\scala3-3.2.1-RC2 \
 -cp C:\opt\scala3-3.2.1-RC2\lib\*.jar -Dscala.usejavacp=true  \
...
[DEBUG] [execute] C:\opt\jdk-11.013_8\bin\java.exe \
 -Xms64m -Xmx1024m -cp C:\opt\scala3-3.2.1-RC2\lib\*.jar;\
...
[INFO] --------------------------------[ jar ]---------------------------------
[..]
[INFO] --- maven-jar-plugin:3.2.1-RC2:jar (default-jar) @ HelloWorld ---
...
>         <b>&lt;scala.version&gt;</b>3.2.1-RC2<b>&lt;/scala.version&gt;</b>
...
<pre style="font-size:80%;">
<b>&gt;</b> <a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html">java</a> -Xbootclasspath/a:c:\opt\scala3-3.2.1-RC2\lib\dotty-library_3-3.2.1-RC2.jar;^
c:\opt\scala3-3.2.1-RC2\lib\scala-library-2.13.9.jar ^
...
> <pre style="font-size:80%;">
> <b>&gt; <a href="https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html">java</a> -Xbootclasspath/a:c:\opt\scala3-3.2.1-RC2\lib\scala3-library_3-3.2.1-RC2.jar -jar target\enum-Color-1.0-SNAPSHOT.jar</b>
...
> Searching for class name Serializable in library files C:\opt\scala3-3.2.1-RC2\lib\*.jar
...
> Searching for class name Serializable in library files C:\opt\scala-2.13.9\lib\*.jar
...
> </pre>
> Class **`scala.Serializable`** is part of **`C:\opt\scala3-3.2.1-RC2\lib\scala-library-2.13.9.jar`**, so let us add it to our classpath !
