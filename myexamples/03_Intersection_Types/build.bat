...
) else if %_VERBOSE%==1 ( echo Compile Java source files to !_CLASSES_DIR:%_ROOT_DIR%=! 1>&2
)
...
) else if %_VERBOSE%==1 ( echo Compile Scala source files to !_CLASSES_DIR:%_ROOT_DIR%=! 1>&2
)
