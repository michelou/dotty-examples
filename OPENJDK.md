...
C:\opt\jdk-sapmachine-11.0.9\         <i>(315 MB)</i>
C:\opt\jdk-zulu-11.0.9\               <i>(300 MB)</i>
</pre>
...
1. Command **`java.exe -version`** displays the OpenJDK version amongst other information; in particular, the last output line ends with
   - **`(build 11.0.9+11-LTS, mixed mode, sharing)`** if data sharing is enabled
   - **`(build 11.0.9+11-LTS, mixed mode)`** otherwise.
...
<pre style="font-size:80%;">
<b>&gt; c:\opt\jdk-corretto-11.0.9_11\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20 LTS
OpenJDK Runtime Environment Corretto-11.0.9.11.2 (build 11.0.9+11-LTS)
OpenJDK 64-Bit Server VM Corretto-11.0.9.11.2 (build 11.0.9+11-LTS, mixed mode)

<b>&gt; c:\opt\jdk-corretto-11.0.9_11\bin\java -Xshare:dump</b>
[...]
Number of classes 1214
[...]
<b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/dir">dir</a> c:\opt\jdk-corretto-11.0.9_11\bin\server | findstr jsa</b>
30.10.2020  00:02        17 629 184 classes.jsa

<b>&gt; c:\opt\jdk-corretto-11.0.9_11\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20 LTS
OpenJDK Runtime Environment Corretto-11.0.9.11.2 (build 11.0.9+11-LTS)
OpenJDK 64-Bit Server VM Corretto-11.0.9.11.2 (build 11.0.9+11-LTS, mixed mode, sharing)
</pre>
...
<pre style="font-size:80%;">
<b>&gt; c:\opt\jdk-liberica-11.0.9\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20 LTS
OpenJDK Runtime Environment (build 11.0.9+12-LTS)
OpenJDK 64-Bit Server VM (build 11.0.9+12-LTS, mixed mode)

<b>&gt; c:\opt\jdk-liberica-11.0.9\bin\java -Xshare:dump</b>
[...]
Number of classes 1229
[...]
<b>&gt; dir c:\opt\jdk-liberica-11.0.9\bin\server | findstr jsa</b>
04.09.2020  19:48        17 760 256 classes.jsa

<b>&gt; c:\opt\jdk-liberica-11.0.9\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20 LTS
OpenJDK Runtime Environment (build 11.0.9+12-LTS)
OpenJDK 64-Bit Server VM (build 11.0.9+12-LTS, mixed mode, sharing)
</pre>
...
<pre style="font-size:80%;">
<b>&gt; c:\opt\jdk-11.0.9+11\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20
OpenJDK Runtime Environment AdoptOpenJDK (build 11.0.9+11)
OpenJDK 64-Bit Server VM AdoptOpenJDK (build 11.0.9+11, mixed mode)

<b>&gt; c:\opt\jdk-11.0.9+11\bin\java -Xshare:dump</b>
[...]
Number of classes 1214
[...]
<b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/dir">dir</a> c:\opt\jdk-11.0.9+11\bin\server | findstr jsa</b>
30.10.2020  00:04        17 629 184 classes.jsa
&nbsp;
<b>&gt; c:\opt\jdk-11.0.9+11\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20
OpenJDK Runtime Environment AdoptOpenJDK (build 11.0.9+11)
OpenJDK 64-Bit Server VM AdoptOpenJDK (build 11.0.89+11, mixed mode, sharing)
</pre>
...
<pre style="font-size:80%;">
<b>&gt; c:\opt\jdk-sapmachine-11.0.9\bin\java -version</b>
openjdk version "11.0.9" 2020-10-22 LTS
OpenJDK Runtime Environment SapMachine (build 11.0.9+11-LTS-sapmachine)
OpenJDK 64-Bit Server VM SapMachine (build 11.0.9+11-LTS-sapmachine, mixed mode)
&nbsp;
<b>&gt; c:\opt\jdk-sapmachine-11.0.9\bin\java -Xshare:dump</b>
[...]
Number of classes 1214
[...]
<b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/dir">dir</a> c:\opt\jdk-sapmachine-11.0.9\bin\server | findstr jsa</b>
30.10.2020  09:39        17 629 184 classes.jsa
&nbsp;
<b>&gt; c:\opt\jdk-sapmachine-11.0.9\bin\java -version</b>
openjdk version "11.0.9" 2020-10-22 LTS
OpenJDK Runtime Environment SapMachine (build 11.0.9+11-LTS-sapmachine)
OpenJDK 64-Bit Server VM SapMachine (build 11.0.9+11-LTS-sapmachine, mixed mode, sharing)
</pre>
...
<pre style="font-size:80%;">
<b>&gt; c:\opt\jdk-zulu-11.0.9\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20 LTS
OpenJDK Runtime Environment Zulu11.43+21-CA (build 11.0.9+10-LTS)
OpenJDK 64-Bit Server VM Zulu11.43+21-CA (build 11.0.9+10-LTS, mixed mode)
&nbsp;
<b>&gt; c:\opt\jdk-zulu-11.0.9\bin\java -Xshare:dump</b>
[...]
Number of classes 1228
[...]
<b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/dir">dir</a> c:\opt\jdk-zulu-11.0.9\bin\server | findstr jsa</b>
30.10.2020  09:20        17 760 270 classes.jsa
&nbsp;
<b>&gt; c:\opt\jdk-zulu-11.0.9\bin\java -version</b>
openjdk version "11.0.9" 2020-10-20 LTS
OpenJDK Runtime Environment Zulu11.43+21-CA (build 11.0.9+11-LTS)
OpenJDK 64-Bit Server VM Zulu11.43+21-CA (build 11.0.9+11-LTS, mixed mode, sharing)
</pre>
...
<a href="https://docs.aws.amazon.com/corretto/latest/corretto-11-ug/downloads-list.html" rel="external">amazon-corretto-11.0.9.11.2-windows-x64-jdk.zip</a>                <i>(177 MB)</i>
<a href="https://bell-sw.com/pages/downloads/#/java-11-lts">bellsoft-jdk11.0.9+12-windows-amd64.zip</a>                        <i>(186 MB)</i>
